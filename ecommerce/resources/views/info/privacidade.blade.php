...
<div class="container">
    ...
    <p><span style="color: rgb(68, 68, 68);">A sua privacidade é importante para nós. É política do Ecommerce respeitar a
            sua
            privacidade em relação a qualquer informação sua que possamos coletar no site <a
                href="https://ecommerce.com">Ecommerce</a>, e outros sites que possuímos e operamos.</span></p>
    ...
    <p><span style="color: rgb(68, 68, 68);">
            <ul>
                ...
                <li><span style="color: rgb(68, 68, 68);">Utilizamos anúncios para compensar os custos de funcionamento
                        ...
                        anúncios
                        mais relevantes sempre que possível, rastreando anonimamente seus interesses e apresentando
                        coisas
    ...
    <p><span style="color: rgb(68, 68, 68);">O usuário se compromete a fazer uso adequado dos conteúdos e da informação
            que
            o Ecommerce oferece no site e com caráter enunciativo, mas não limitativo:</span></p>
    <ul>
        ...
        <li><span style="color: rgb(68, 68, 68);">B) Não difundir propaganda ou conteúdo de natureza racista,
                xenofóbica,
            </span><span style="color: rgb(33, 37, 41);"><a href='https://166bet.br.com'
        ...
        <li><span style="color: rgb(68, 68, 68);">C) Não causar danos aos sistemas físicos (hardwares) e lógicos
                (softwares)
                do Ecommerce, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou
    ...
    <p><span style="color: rgb(68, 68, 68);">Esta política é efetiva a partir de&nbsp;27 January 2025 00:39</span></p>
</div>
