...
<div class="container">
    <h2>1. Termos</h2>
    <p><span style="color: rgb(68, 68, 68);">Ao acessar ao site <a href="https://ecommerce.com">Ecommerce</a>, concorda em
            cumprir estes termos de serviço, todas as leis e regulamentos aplicáveis ​​e concorda que é responsável pelo
            cumprimento de todas as leis locais aplicáveis. Se você não concordar com algum desses termos, está proibido
            de
    ...
    <p><span style="color: rgb(68, 68, 68);">É concedida permissão para baixar temporariamente uma cópia dos materiais
            (informações ou software) no site Ecommerce , apenas para visualização transitória pessoal e não comercial.
            Esta
    ...
    <p><span style="color: rgb(68, 68, 68);">Esta licença será automaticamente rescindida se você violar alguma dessas
            restrições e poderá ser rescindida por Ecommerce a qualquer momento. Ao encerrar a visualização desses
            materiais
    ...
    <ol>
        <li><span style="color: rgb(68, 68, 68);">Os materiais no site da Ecommerce são fornecidos 'como estão'.
                Ecommerce
        ...
        <li><span style="color: rgb(68, 68, 68);">Além disso, o Ecommerce não garante ou faz qualquer representação
                relativa
                à precisão, aos resultados prováveis ​​ou à confiabilidade do uso dos materiais em seu site ou de outra
                forma relacionado a esses materiais ou em sites vinculados a este site.</span></li>
    </ol>
    <h2>4. Limitações</h2>
    <p><span style="color: rgb(68, 68, 68);">Em nenhum caso o Ecommerce ou seus fornecedores serão responsáveis ​​por
            quaisquer danos (incluindo, sem limitação, danos por perda de dados ou lucro ou devido a interrupção dos
            negócios) decorrentes do uso ou da incapacidade de usar os materiais em Ecommerce, mesmo que Ecommerce ou um
            representante autorizado da Ecommerce tenha sido notificado oralmente ou por escrito da possibilidade de
            tais
    ...
    <p><span style="color: rgb(68, 68, 68);">Os materiais exibidos no site da Ecommerce podem incluir erros técnicos,
            tipográficos ou fotográficos. Ecommerce não garante que qualquer material em seu site seja preciso, completo
            ou
            atual. Ecommerce pode fazer alterações nos materiais contidos em seu site a qualquer momento, sem aviso
            prévio.
            No entanto, Ecommerce não se compromete a atualizar os materiais.</span></p>
    <h2>6. Links</h2>
    <p><span style="color: rgb(68, 68, 68);">O Ecommerce não analisou todos os sites vinculados ao seu site e não é
            responsável pelo conteúdo de nenhum site vinculado. A inclusão de qualquer link não implica endosso por
            Ecommerce do site. O uso de qualquer site vinculado é por conta e risco do usuário.</span></p>
    <p><br></p>
    <h3>Modificações</h3>
    <p><span style="color: rgb(68, 68, 68);">O Ecommerce pode revisar estes termos de serviço do site a qualquer
            momento,
    ...
    <p><span style="color: rgb(68, 68, 68);">Estes termos e condições são regidos e interpretados de acordo com as leis
            do
            Ecommerce e você se submete irrevogavelmente à jurisdição exclusiva dos tribunais naquele estado ou
            localidade.</span></p>
</div>
